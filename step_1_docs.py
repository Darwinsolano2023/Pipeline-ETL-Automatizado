...
def main():
    ...
    # Cargar rutas
    carpeta_entrada = "./Version 2/Archivos Enwis/Items/"
    ...
    try:
        ...
        print("Paso 1 = Error")
        print(f"Paso 1 = Error al leer {archivos[0]}: {e}")
        return errors_step_1
    ...
    try:
        ...
        print(f"Paso 1 = Error al leer {archivo}: {e}")
    ...
    for archivo in archivos:
        ...
        try:
            ...
            print(f"Paso 1 = Error al eliminar {archivo}: {e}")
    ...
    if not errores_detectados and errors_step_1.empty:
        ...
        print("Paso 1 = Error")
        print("Paso 1 = Error (ver detalles arriba)")
